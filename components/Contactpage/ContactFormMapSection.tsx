      ...
      >
        ...
        >
          ...
          <form className="mt-7 space-y-4">
            ...
            <motion.button
              type="submit"
              className="mt-3 rounded-full bg-[#9a1b79] px-7 py-3 font-primary text-[13px] font-semibold uppercase tracking-[3px] text-white transition duration-300 hover:bg-[#D6B981] hover:text-[#200020]"
